...
const I18N = {
  ja: {
    ...
    vocalLanguage: "歌う言語",
    vocalLanguageHint: "歌詞の言語と食い違う値を選ぶと発音が崩れます。自動なら歌詞の文字から判定します（かな・ハングル・キリル文字など）。ラテン文字は判定できないので、英語以外はここで選んでください。",
    vocalLanguageAuto: "自動（歌詞の文字から判定）",
    create: "作る",
    creating: "作っています…",
  ...
  en: {
    ...
    vocalLanguageHint: "A value that disagrees with the lyrics breaks pronunciation. Auto reads the script (kana, hangul, Cyrillic). Latin script is ambiguous, so pick it here for anything but English.",
    vocalLanguageAuto: "Auto (from the lyrics' script)",
    create: "Create",
    creating: "Creating…",
